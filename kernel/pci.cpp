...
namespace {
  ...
  /** @brief Writes information into devices[num_device] and increments num_device */
   ...
   * If it is a PCI-PCI bridge, runs ScanBus on its secondary bus.
   */
  ...
  /** @brief Scans all functions of the specified device number.
   * For each valid function found, calls ScanFunction.
   */
  ...
  /** @brief Scans all devices on the specified bus number.
   * For each valid device found, calls ScanDevice.
   */
  Error ScanBus(uint8_t bus) {
   ...
   *
   * @param dev  PCI device from which to read the MSI capability
   * @param cap_addr  Configuration space address of the MSI capability register
   */
   ...
   *
   * @param dev  PCI device to write the MSI capability to
   * @param cap_addr  Configuration space address of the MSI capability register
  ...
  /** @brief Configures the specified MSI register */
  ...
  /** @brief Configures the specified MSI-X register */
