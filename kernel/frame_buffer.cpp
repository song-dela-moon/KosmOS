...
// Initialize frame buffer from config (use existing buffer or allocate)
...
// #@@range_begin(copy)
// Copy source frame buffer into this buffer at the given position
...
// Return bits per pixel for the given pixel format, or -1 if unknown
