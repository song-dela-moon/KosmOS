 ...
 *
 * Transfer Request Block related definitions.
 */
...
namespace usb::xhci {
  ...
  /** @brief TRBDynamicCast casts a TRB pointer to another TRB type.
   *
   * @param trb  Source pointer
   * @return  Casted pointer if the source TRB's type matches the target type. nullptr otherwise.
   */
