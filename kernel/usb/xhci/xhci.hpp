 ...
 *
 * xHCI host controller control class.
 */
...
namespace usb::xhci {
  ...
  /** @brief Processes at most one event from the event ring.
   *
   * Processes the front event of xhc's primary event ring.
   * Returns Error::kSuccess immediately if no event is present.
   *
